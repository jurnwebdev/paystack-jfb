...
class Settings {
  public static function init(){ add_action('admin_menu',[__CLASS__,'menu']); add_action('admin_init',[__CLASS__,'reg']); }
  ...
  public static function render(){ ?>
    <div class="wrap"><h1><?php esc_html_e('Paystack for JetFormBuilder','paystack-jfb'); ?></h1>
      <form method="post" action="options.php"><?php settings_fields('paystack_jfb_group'); do_settings_sections('paystack-jfb'); submit_button(); ?></form>
      <hr/><h2><?php esc_html_e('Usage','paystack-jfb'); ?></h2>
